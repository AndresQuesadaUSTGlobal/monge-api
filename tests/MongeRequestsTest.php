...
final class MongeRequestsTest extends ParentRequestsTest
{
    ...
    public function testGuardarDatosAdicionales(): void
    {
        $results = static::getClient()->GuardarDatosAdicionales(
            "52826B18-C5D6-4761-9B20-8D9836E207B0",
            1,
            2,
            3,
            "Karen",
            ...
            1,
            2,
            "2017-05-03T21:28:24.379Z",
            "Grupo Monge",
            "2013-03-20T21:28:24.379Z",
            "22660055",
            1000,
            "Col las palmeras",
            1,
    ...
    {
        $results = static::getClient()->EnviarOtp("UsuarioTV@grupomonge.com",
            "Email",
            "UsuarioTV@grupomonge.com",
            0,
            "00-1234-0121");
        $this->assertIsObject($results);
    }
